// Prebuilt endpoint bundle — mirrors src/index.js (zero dependencies, no
// build step required; rebuild = copy src/index.js).
// Extension: deere-shop-search (GET /deere-shop/search).
