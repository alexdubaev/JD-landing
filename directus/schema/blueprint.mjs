  ...
  collections: [
    ...
    },
    {
      ...
      fields: contentFields(
        ...
        field("primary_cta_text", "string"),
        field("primary_cta_url", "string"),
        field("secondary_cta_text", "string"),
        field("secondary_cta_url", "string"),
    ...
    {
      name: "seo_text_blocks",
      icon: "text_snippet",
      fields: contentFields(
        field("page_type", "string", { required: true, index: true }),
        field("related_page", "uuid", { relatedCollection: "pages" }),
        field("related_category", "uuid", {
          relatedCollection: "categories",
        }),
        field("related_product", "uuid", { relatedCollection: "products" }),
        field("h1", "string"),
        field("intro_text", "text"),
        field("content_blocks", "json"),
        field("conclusion_text", "text"),
        field("cta_text", "string"),
        field("primary_keywords", "json"),
        field("secondary_keywords", "json"),
        field("search_intent", "string"),
        field("internal_links", "json"),
        field("faq_items", "json"),
        field("image_alt_texts", "json"),
        field("seo_title", "string"),
        field("seo_description", "text"),
        field("og_title", "string"),
        field("og_description", "text"),
